    ...
    public void execute()
        ...
        try {
            ...
            if (startWaitSeconds >= 0) {
                ...
                getLog().info(" rpcAddress: " + rpcAddress + ", rpcPort: " + rpcPort +", nativeTransportPort: " + nativeTransportPort +", startWaitSeconds: " + startWaitSeconds);
